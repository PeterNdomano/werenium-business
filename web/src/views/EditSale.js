...
export default class EditSale extends Component{
  ...
  constructor(props){
    ...
    this.rowsData = [];
    this.total = props.item.data.total;
          ...
          <div className="card-body">
            <div className="row">
              <div className="col-md-6">
                <MDBInput value={this.props.item.data.customerName}  id="cName" label="Customer Name (Optional)" type="text"/>
              </div>
              <div className="col-md-6">
                <MDBInput value={this.props.item.data.customerDetails} id="cDetails" label="Customer Details eg Phone, Address (Optional)" type="text"/>
              </div>
              <div className="col-md-6">
            ...
            <div className="row">
              <div className="col-md-6">
                <MDBInput id="cAmountPaid" value={this.props.item.data.amountPaid} label="Amount Paid By Customer Currently" type="number"/>
                <h6 className="text-danger font-regular" style={{ fontSize:"12px" }}>
